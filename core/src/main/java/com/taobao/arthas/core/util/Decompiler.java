...
public class Decompiler {
    ...
    public static String decompile(String classFilePath, String methodName, boolean hideUnicode,
            boolean printLineNumber, boolean relinkConstants) {
        return decompileWithMappings(classFilePath, methodName, hideUnicode, printLineNumber, relinkConstants)
                .getFirst();
    }

    public static Pair<String, NavigableMap<Integer, Integer>> decompileWithMappings(String classFilePath,
            String methodName, boolean hideUnicode, boolean printLineNumber, boolean relinkConstants) {
        final StringBuilder sb = new StringBuilder(8192);
        ...
        options.put("hideutf", String.valueOf(hideUnicode));
        options.put("trackbytecodeloc", "true");
        options.put("relinkconst", String.valueOf(relinkConstants));
        if (!StringUtils.isBlank(methodName)) {
            options.put("methodname", methodName);
        }
